...
const ProjectCard = ({ project_name, made_by, tec_use, images, key }) => {
    ...
    return (
        <div className="container min-w-min max-w-fit flex flex-col items-center bg-P_card_color border-2 border-Border_card/50 rounded-lg relative text-Title_color">
